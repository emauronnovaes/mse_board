...
// Limite de tamanho (10 MB) — evita que alguém mande um payload gigante pra travar o servidor
if (strlen($raw) > 10 * 1024 * 1024) {
    http_response_code(413);
    echo json_encode(['error' => 'Dados enviados são grandes demais (limite de 10 MB).']);
    exit;
}
